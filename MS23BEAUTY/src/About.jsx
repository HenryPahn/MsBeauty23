  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="font-Montserrat flex-grow">
        <div className="flex flex-col items-center justify-center mt-24 lg:mt-56 lg:mb-0 xl:mt-32 xl:mb-16">
          <div className="relative w-11/12 md:w-10/12">
            ...
            <div className="md:absolute inset-0 md:bg-black md:bg-opacity-50 flex items-center justify-center">
              <p className="text-black md:text-white text-justify font-bold font-Montserrat p-4 lg:text-xl 2xl:text-3xl">
